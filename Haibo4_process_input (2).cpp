...
int main(int argc, char** argv) {
	ifstream fin("E://TDDOWNLOAD//fugailv//201407//duowan_100w_rest.txt");
	ofstream fout("E://TDDOWNLOAD//fugailv//覆盖率测试包含全部长度的字母组件//alpha_with_all_length//duowan_100w_rest_alpha_tmp.txt");
	if (!fin)
...
//	int tmpcnt= cnt;
	...
	ifstream fin2("E://TDDOWNLOAD//fugailv//覆盖率测试包含全部长度的字母组件//alpha_with_all_length//duowan_100w_rest_alpha_tmp.txt");
	if (!fin2)
		cout << "dakaishibai" << endl;
	ofstream fout2("E://TDDOWNLOAD//fugailv//覆盖率测试包含全部长度的字母组件//alpha_with_all_length_sorted//duowan_100w_rest_alpha_sorted.txt");
	char str2[100];
	while(fin2>>str2){
